...
#                 elif 'sala' in linked_zone_name and 'wc' in zone_name:
...
def apply_rules_to_fenestration_surfaces(building_surfaces_data, fenestration_surfaces_data):
    for fenestration_surface in fenestration_surfaces_data:
        ...
        if construction_name in ['Exterior Door', 'Exterior Window']:
            ...
            linked_building_surface_name = None
            linked_zone_name = None
            linked_fenestration_name = None  # Defina a variável aqui

            print("Searching for linked_fenestration_name:", linked_fenestration_name)

            for fenestration_surface in fenestration_surfaces_data:
                if fenestration_surface['Name'] == linked_fenestration_name:
                    linked_building_surface_name = fenestration_surface['Building Surface Name']
                    print("Linked Building Surface Name:", linked_building_surface_name)
                    break

            for building_surface in building_surfaces_data:
                if building_surface['Name'] == linked_building_surface_name:
                    linked_zone_name = building_surface['Zone Name']
                    linked_fenestration_name = building_surface['Outside Boundary Condition Object']  # Adicione essa linha
                    print("Linked Zone Name:", linked_zone_name)
                    break
            ...
            #     if fenestration_surface['Name'] == linked_fenestration_name:
            #         linked_building_surface_name = fenestration_surface['Building Surface Name']
            #         linked_construction_name = fenestration_surface['Construction Name']
            #         linked_zone_name = building_surface['Zone Name']
            #         break

            if linked_zone_name is not None and zone_name is not None:
                if ('sala' in linked_zone_name and 'quarto' in zone_name) or ('quarto' in linked_zone_name and 'sala' in zone_name):
                    new_name = 'PQ-' + fenestration_surface['Name']
                elif ('sala' in linked_zone_name and 'wc' in zone_name) or ('wc' in linked_zone_name and 'sala' in zone_name):
                    new_name = 'PB-' + fenestration_surface['Name']
                elif ('wc' in linked_zone_name and 'quarto' in zone_name) or ('quarto' in linked_zone_name and 'wc' in zone_name):
                    new_name = 'PB-' + fenestration_surface['Name']
                elif 'sala' in linked_zone_name and 'circ' in zone_name:
                    new_name = 'PS-' + fenestration_surface['Name']

                fenestration_surface['Name'] = new_name
