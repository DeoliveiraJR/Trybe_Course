...
# Anota aí ✏️: Parâmetros posicionais variádicos são acessados como uma tupla no
# interior de uma função, e parâmetros nomeados variádicos como um dicionário.
def concat(*strings):
    # Equivalente a um ", ".join(strings), que concatena os elementos de um iterável
    # em uma string utilizando um separador
